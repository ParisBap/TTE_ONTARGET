**** DO-FILE TO IMPUTE MISSING VALUES FOR PATIENTS OF SOUTH ASIAN ETHNICITY USING MULTIPLE IMPUTATION OF CHAINED EQUATIONS ****
...
mvpatterns stroke_TIA DM_prior PAD_any ageAtPeriod DM_comps CAD_any smokstatus bmicat sex statin nitrate DM_treatment diuretic ccb betablocker aspirin alphablocker antiplatelet oac imd_5  hospln year  sys_bp dia_bp timesince aceicounter arbcounter GP_apt arbcounter2 GP2 timesince2 age2 SCr 

* set up flags to identify obs in which particular vars are missing 
foreach var of varlist stroke_TIA DM_prior PAD_any ageAtPeriod DM_comps CAD_any smokstatus bmicat sex statin nitrate DM_treatment diuretic ccb betablocker aspirin alphablocker antiplatelet oac imd_5  hospln year  sys_bp dia_bp timesince aceicounter arbcounter GP_apt arbcounter2 GP2 timesince2 age2 SCr _d HT  SCr {
	gen `var'_i = `var' 
}

* dry run to check format
ice stroke_TIA_i DM_prior_i PAD_any_i ageAtPeriod_i DM_comps_i CAD_any_i smokstatus_i bmicat_i sex_i statin_i nitrate_i DM_treatment_i diuretic_i ccb_i betablocker_i aspirin_i alphablocker_i antiplatelet_i oac_i imd_5_i hospln_i  year_i  sys_bp_i dia_bp_i timesince_i aceicounter_i arbcounter_i GP_apt_i arbcounter2_i GP2_i timesince2_i age2_i SCr_i _d_i HT_i, dryrun
...
preserve 
	...
	ice nscore1-nscore3 stroke_TIA_i DM_prior_i PAD_any_i ageAtPeriod_i DM_comps_i CAD_any_i smokstatus_i bmicat_i sex_i statin_i nitrate_i DM_treatment_i diuretic_i ccb_i betablocker_i aspirin_i alphablocker_i antiplatelet_i oac_i imd_5_i hospln_i  year_i  timesince_i aceicounter_i arbcounter_i GP_apt_i arbcounter2_i GP2_i timesince2_i age2_i _d_i HT_i , saving("mit_sa", replace)  m(1)  seed(999)
	use mit_sa, clear
	invnscore sys_bp_i SCr_i  dia_bp_i 
	save, replace
restore
...
preserve 
	...
	ice nscore1-nscore3 stroke_TIA_i DM_prior_i PAD_any_i ageAtPeriod_i DM_comps_i CAD_any_i smokstatus_i bmicat_i sex_i statin_i nitrate_i DM_treatment_i diuretic_i ccb_i betablocker_i aspirin_i alphablocker_i antiplatelet_i oac_i imd_5_i hospln_i  year_i  timesince_i aceicounter_i arbcounter_i GP_apt_i arbcounter2_i GP2_i timesince2_i age2_i _d_i HT_i , saving("miu_sa", replace)  m(10)  seed(999)
	use miu_sa, clear
	invnscore sys_bp_i SCr_i  dia_bp_i 
	save, replace
restore
...
preserve 
	...
	ice nscore1-nscore3 stroke_TIA_i DM_prior_i PAD_any_i ageAtPeriod_i DM_comps_i CAD_any_i smokstatus_i bmicat_i sex_i statin_i nitrate_i DM_treatment_i diuretic_i ccb_i betablocker_i aspirin_i alphablocker_i antiplatelet_i oac_i imd_5_i hospln_i  year_i  timesince_i aceicounter_i arbcounter_i GP_apt_i arbcounter2_i GP2_i timesince2_i age2_i _d_i HT_i , saving("mit_sa", replace)  m(10)  seed(999)
	use mit_sa, clear
	invnscore sys_bp_i SCr_i  dia_bp_i 
	save, replace
restore
