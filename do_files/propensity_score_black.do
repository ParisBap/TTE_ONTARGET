**** DO-FILE TO GENERATE PS USING PS MODEL FOR PATIENTS OF BLACK ETHNICITY ****
...
save "${datadir}\1 PERIOD PER PT - RANDOM\ACEi_ARB_ps_model_vars_black.dta", replace
...
save "${datadir}\1 PERIOD PER PT - RANDOM\ACEi_ARB_PS_BLACK.dta", replace
