**** DO-FILE TO GENERATE PS USING PS MODEL FOR PATIENTS OF SOUTH ASIAN ETHNICITY ****
...
logistic exposed i.stroke_TIA i.DM_prior i.PAD_any c.ageAtPeriod i.DM_comps i.CAD_any i.smokstatus i.bmicat i.sex i.statin i.nitrate i.DM_treatment i.diuretic i.ccb i.betablocker i.aspirin i.alphablocker i.antiplatelet i.oac i.imd_5  c.hospln c.year sys_bp dia_bp c.timesince c.aceicounter c.arbcounter c.arbcounter2 c.GP_apt  i.SCr_nmiss c.SCr_new c.age2
...
** systolic BP
gen sbp2=sys_bp^2 
logistic exposed i.stroke_TIA i.DM_prior i.PAD_any c.ageAtPeriod i.DM_comps i.CAD_any i.smokstatus i.bmicat i.sex i.statin i.nitrate i.DM_treatment i.diuretic i.ccb i.betablocker i.aspirin i.alphablocker i.antiplatelet i.oac i.imd_5  c.hospln c.year sys_bp dia_bp c.timesince c.aceicounter c.arbcounter c.GP_apt  i.SCr_nmiss c.SCr_new c.sbp2
est store B
...
** diastolic BP
gen dbp2=dia_bp^2 
logistic exposed i.stroke_TIA i.DM_prior i.PAD_any c.ageAtPeriod i.DM_comps i.CAD_any i.smokstatus i.bmicat i.sex i.statin i.nitrate i.DM_treatment i.diuretic i.ccb i.betablocker i.aspirin i.alphablocker i.antiplatelet i.oac i.imd_5  c.hospln c.year sys_bp dia_bp c.timesince c.aceicounter c.arbcounter c.GP_apt  i.SCr_nmiss c.SCr_new c.dbp2
est store B
...
logistic exposed i.stroke_TIA i.DM_prior i.PAD_any c.ageAtPeriod i.DM_comps i.CAD_any i.smokstatus i.bmicat i.sex i.statin i.nitrate i.DM_treatment i.diuretic i.ccb i.betablocker i.aspirin i.alphablocker i.antiplatelet i.oac i.imd_5  c.hospln c.year sys_bp dia_bp c.timesince c.aceicounter c.arbcounter c.GP_apt  i.SCr_nmiss c.SCr_new c.timesince2
est store B
...
logistic exposed i.stroke_TIA i.DM_prior i.PAD_any c.ageAtPeriod i.DM_comps i.CAD_any i.smokstatus i.bmicat i.sex i.statin i.nitrate i.DM_treatment i.diuretic i.ccb i.betablocker i.aspirin i.alphablocker i.antiplatelet i.oac i.imd_5  c.hospln c.year sys_bp dia_bp c.timesince c.aceicounter c.arbcounter c.GP_apt  i.SCr_nmiss c.SCr_new c.aceicounter2
est store B
...
** Serum creatinine
gen scr2=SCr_new^2 
logistic exposed i.stroke_TIA i.DM_prior i.PAD_any c.ageAtPeriod i.DM_comps i.CAD_any i.smokstatus i.bmicat i.sex i.statin i.nitrate i.DM_treatment i.diuretic i.ccb i.betablocker i.aspirin i.alphablocker i.antiplatelet i.oac i.imd_5  c.hospln c.year sys_bp dia_bp c.timesince c.aceicounter c.arbcounter c.GP_apt  i.SCr_nmiss c.SCr_new c.scr2
est store B
...
** no. of GP appointments
gen GP2=GP_apt^2 
logistic exposed i.stroke_TIA i.DM_prior i.PAD_any c.ageAtPeriod i.DM_comps i.CAD_any i.smokstatus i.bmicat i.sex i.statin i.nitrate i.DM_treatment i.diuretic i.ccb i.betablocker i.aspirin i.alphablocker i.antiplatelet i.oac i.imd_5  c.hospln c.year sys_bp dia_bp c.timesince c.aceicounter c.arbcounter c.GP_apt  i.SCr_nmiss c.SCr_new c.GP2
est store B
...
logistic exposed i.stroke_TIA i.DM_prior i.PAD_any c.ageAtPeriod i.DM_comps i.CAD_any i.smokstatus i.bmicat i.sex i.statin i.nitrate i.DM_treatment i.diuretic i.ccb i.betablocker i.aspirin i.alphablocker i.antiplatelet i.oac i.imd_5  c.hospln c.year sys_bp dia_bp c.timesince c.aceicounter c.arbcounter c.GP_apt  i.SCr_nmiss c.SCr_new  c.arbcounter2 c.GP2 c.aceicounter2 c.timesince2 c.age2

* remove insignificant variables

logistic exposed i.stroke_TIA i.DM_prior i.PAD_any c.ageAtPeriod i.DM_comps i.CAD_any i.smokstatus i.bmicat i.sex i.statin i.nitrate i.DM_treatment i.diuretic i.ccb i.betablocker i.aspirin i.alphablocker i.antiplatelet i.oac i.imd_5  c.hospln c.year sys_bp dia_bp c.timesince c.aceicounter c.arbcounter c.GP_apt  i.SCr_nmiss c.SCr_new  c.arbcounter2 c.GP2  c.timesince2 c.age2

* save dataset containing variables in included in propensity score model
save "${datadir}\1 PERIOD PER PT - RANDOM\ACEi_ARB_ps_model_vars_sa.dta", replace
...
save "${datadir}\1 PERIOD PER PT - RANDOM\ACEi_ARB_PS_SA.dta", replace
